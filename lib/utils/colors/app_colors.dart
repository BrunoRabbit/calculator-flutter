...
class AppColors {
  ...
  static const Color kButtonBackgroundColor = Color(0xff141414);
  static const Color kButtonEqualBackgroundColor = Color(0xff76B9ED);

  // ? Light Theme
  static const Color kLightEqualButton = Color(0xff0370C4);
